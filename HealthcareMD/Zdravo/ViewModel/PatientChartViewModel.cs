...
namespace HealthcareMD.ViewModel
{
    public class PatientChartViewModel
    {
        ...
        private void InitFields(Patient p)
        {
            ...
            switch (p.Status)
            {
                case HealthcareMD.MarriageStatus.married:
                    marriageStatus = 'm';
                    break;
                case HealthcareMD.MarriageStatus.widow:
                    marriageStatus = 'w';
                    break;
                case HealthcareMD.MarriageStatus.divorced:
                    marriageStatus = 'd';
                    break;
                case HealthcareMD.MarriageStatus.single:
                    marriageStatus = 's';
                    break;
            }
        }
